...
-- System
hl.bind(mainMod .. " + CTRL + semicolon", hl.dsp.exec_cmd("systemctl poweroff ; loginctl poweroff"))
hl.bind(mainMod .. " + CTRL + ALT + semicolon", hl.dsp.exec_cmd("systemctl reboot ; loginctl reboot"))
...
-- Screenshot
hl.bind(mainMod .. " + S", hl.dsp.exec_cmd('grim -g "$(slurp -c cba6f7ff -b 11111155 -s 1e1e2e44)" - | wl-copy'))

-- DMS
hl.bind(mainMod .. " + Space", hl.dsp.exec_cmd("dms ipc spotlight toggle"))
hl.bind(mainMod .. " + ALT + Space", hl.dsp.exec_cmd("dms ipc bar toggle"))
hl.bind(mainMod .. " + CTRL + L", hl.dsp.exec_cmd("dms ipc lock lock"))
